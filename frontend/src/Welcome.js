...
const Welcome = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0B3D2E] via-[#134E3E] to-[#0B3D2E] flex flex-col" data-testid="welcome-page">
      {/* Background Pattern */}
      ...
      <div className="relative flex-1 flex flex-col items-center justify-center px-8">
        ...
        <div className="relative mb-8">
          <div className="absolute -inset-4 bg-gradient-to-r from-[#00D09C] to-[#10B981] rounded-full blur-xl opacity-30 animate-pulse" />
          <div className="relative w-24 h-24 rounded-full bg-gradient-to-br from-[#00D09C] to-[#10B981] flex items-center justify-center shadow-2xl">
        ...
        <div className="grid grid-cols-3 gap-4 mb-12 w-full max-w-sm">
          <div className="flex flex-col items-center gap-2">
            <div className="w-12 h-12 rounded-xl bg-white/10 flex items-center justify-center">
              <PiggyBank className="h-6 w-6 text-[#00D09C]" />
            </div>
            <span className="text-white/60 text-xs text-center">Track Wealth</span>
          </div>
          <div className="flex flex-col items-center gap-2">
            <div className="w-12 h-12 rounded-xl bg-white/10 flex items-center justify-center">
              <Target className="h-6 w-6 text-[#00D09C]" />
            </div>
        ...
        <button
          ...
          className="w-full max-w-sm py-4 rounded-2xl bg-gradient-to-r from-[#00D09C] to-[#10B981] text-white text-lg font-semibold shadow-lg shadow-[#00D09C]/30 transition-all hover:shadow-xl hover:shadow-[#00D09C]/40 active:scale-[0.98]"
