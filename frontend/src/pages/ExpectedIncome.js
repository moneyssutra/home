...
import { ArrowLeft, Clock, Briefcase, Building2, Laptop, Home, Coins, TrendingUp, Banknote, Gift } from "lucide-react";
...
const ExpectedIncome = () => {
  ...
  return (
    <div className="min-h-screen pb-8" style={{ backgroundColor: "var(--bg-app)" }} data-testid="expected-income-page">
      ...
      <div className="px-6 -mt-6 space-y-3">
        {items.length === 0 ? (
          ...
          return (
            <div key={idx} className="rounded-xl p-4 shadow-card flex items-center gap-3" style={{ backgroundColor: "var(--bg-card)", border: "1px solid var(--border-light)" }} data-testid={`expected-item-${idx}`}>
