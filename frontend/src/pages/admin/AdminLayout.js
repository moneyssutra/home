...
import { LayoutDashboard, Users, ShieldAlert, TrendingUp, LogOut, Activity, Timer, Layers, FlaskConical } from "lucide-react";
...
const navItems = [
  ...
  { to: "/admin/segmentation", icon: FlaskConical, label: "Segmentation Lab" },
