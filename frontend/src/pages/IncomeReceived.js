...
import { ArrowLeft, CheckCircle2, ChevronRight, Briefcase, Building2, Laptop, Home, Coins, TrendingUp, Banknote, Gift } from "lucide-react";
...
const IncomeReceived = () => {
  ...
  return (
    <div className="min-h-screen pb-24" style={{ backgroundColor: "var(--bg-app)" }} data-testid="income-received-page">
        ...
        {items.length === 0 ? (
          ...
          return (
            <div
              ...
              style={{ backgroundColor: "var(--bg-card)", border: "1px solid var(--border-light)" }}
              onClick={() => item.id ? navigate(`/wealth/income/${item.id}`) : null}
              data-testid={`received-item-${idx}`}
            >
