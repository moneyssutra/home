...
const incomeTypes = [
  ...
  { key: "Rental", label: "Rental", desc: "Add property asset with rental income", icon: Home, color: "#F59E0B", bg: "#FFFBEB", path: "/add-asset" },
  ...
  { key: "Interest", label: "Interest", desc: "Add investment with interest income", icon: TrendingUp, color: "#0891B2", bg: "#ECFEFF", path: "/add-investment" },
  { key: "Dividend", label: "Dividend", desc: "Add investment with dividend income", icon: PieChart, color: "#10B981", bg: "#ECFDF5", path: "/add-investment" },
