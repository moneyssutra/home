...
const CreditCardForm = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAF9] flex flex-col" data-testid="credit-card-form-page">
      {/* Header */}
      ...
      <div className="flex-1 overflow-y-auto pb-6">
        <form onSubmit={handleSubmit} className="mx-auto w-full max-w-[620px] px-6">
          <div className="space-y-6">
            {/* Card Name */}
            <div>
              <label htmlFor="cardName" className="block text-sm font-medium text-[#0B3D2E] mb-2">
            ...
            {/* Bank Name */}
            <div>
              <label htmlFor="bankName" className="block text-sm font-medium text-[#0B3D2E] mb-2">
            ...
            <div>
              ...
              {parseFloat(creditLimit) > 0 && (
                <p className="mt-1.5 text-xs text-[#0B3D2E]/50 italic">{numberToWords(parseFloat(creditLimit))}</p>
              )}
            ...
            <div>
              ...
              {parseFloat(outstandingAmount) > 0 && (
                <p className="mt-1.5 text-xs text-[#0B3D2E]/50 italic">{numberToWords(parseFloat(outstandingAmount))}</p>
              )}
            </div>

            {/* Billing Cycle Date */}
            <div>
              <label htmlFor="billingDate" className="block text-sm font-medium text-[#0B3D2E] mb-2">
                Billing Cycle Date
              </label>
              <select
                id="billingDate"
              ...
              <p className="text-xs text-[#0B3D2E]/50 mt-1">Statement generation date</p>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="e.g., 42"
                  className="w-full px-4 py-3 pr-10 rounded-xl border border-[#E2E8F0] bg-white text-[#0B3D2E] placeholder-[#0B3D2E]/40 focus:border-[#00D09C] focus:outline-none focus:ring-2 focus:ring-[#00D09C]/20"
                  data-testid="interest-rate-input"
                />
                <span className="absolute right-4 top-1/2 -translate-y-1/2 text-[#0B3D2E]/60 font-medium">%</span>
              </div>
            </div>
