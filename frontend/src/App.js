...
function AppRouter() {
  ...
  return (
    <Routes>
      ...
      <Route path="/wealth/income/:id" element={<ProtectedRoute><IncomeDetail /></ProtectedRoute>} />
      ...
      <Route path="/wealth/expenses/:id" element={<ProtectedRoute><ExpenseDetail /></ProtectedRoute>} />
