  ...
  return (
    <div className="min-h-screen bg-[#0F172A] pb-24" data-testid="fixed-expenses-page">
      ...
      <div className="px-6 mt-6">
        <h3 className="text-sm font-semibold text-[#E2E8F0] mb-3">All Fixed Expenses</h3>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-12 px-6">
            ...
            <h2 className="text-lg font-semibold text-[#E2E8F0] mb-2">No Fixed Expenses</h2>
            <p className="text-[#E2E8F0]/60 text-center text-sm mb-6">Add your recurring expenses like rent, EMIs, subscriptions</p>
            <button
