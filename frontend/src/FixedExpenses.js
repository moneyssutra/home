...
const FixedExpenses = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAF9] pb-24" data-testid="fixed-expenses-page">
      {/* Header */}
      <header className="bg-gradient-to-br from-[#475569] via-[#64748B] to-[#475569] px-6 pt-8 pb-8">
        ...
        {/* Total Card */}
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-5 border border-white/10" data-testid="fixed-expenses-total">
      ...
      <div className="px-6 mt-6">
        <h3 className="text-sm font-semibold text-[#0B3D2E] mb-3">All Fixed Expenses</h3>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-12 px-6">
            ...
            <h2 className="text-lg font-semibold text-[#0B3D2E] mb-2">No Fixed Expenses</h2>
            <p className="text-[#0B3D2E]/60 text-center text-sm mb-6">Add your recurring expenses like rent, EMIs, subscriptions</p>
            <button
