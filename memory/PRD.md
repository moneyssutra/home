...
- **Add Expense Title**: Fixed white-on-white text issue by updating CSS specificity for non-gradient headers
- **Transport → Travel**: Renamed expense category across all expense components
