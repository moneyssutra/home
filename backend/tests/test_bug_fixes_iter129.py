...
class TestBiometricRPIDFix:
    ...
    def test_debug_headers_returns_correct_rp_id(self):
        ...
        assert data["origin"] == "https://family-finance-hub-21.preview.emergentagent.com", \
            f"Expected origin 'https://family-finance-hub-21.preview.emergentagent.com', got '{data['origin']}'"
