...
class TestBiometricRPIDFix:
    ...
    def test_debug_headers_returns_correct_rp_id(self):
        ...
        assert data["origin"] == "https://invest-integrity-lab.preview.emergentagent.com", \
            f"Expected origin 'https://invest-integrity-lab.preview.emergentagent.com', got '{data['origin']}'"
