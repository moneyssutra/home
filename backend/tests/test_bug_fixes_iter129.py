...
class TestBiometricRPIDFix:
    ...
    def test_debug_headers_returns_correct_rp_id(self):
        ...
        assert data["origin"] == "https://health-gamification-3.preview.emergentagent.com", \
            f"Expected origin 'https://health-gamification-3.preview.emergentagent.com', got '{data['origin']}'"
