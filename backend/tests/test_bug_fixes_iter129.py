...
class TestBiometricRPIDFix:
    ...
    def test_debug_headers_returns_correct_rp_id(self):
        ...
        assert data["origin"] == "https://financial-level-ui.preview.emergentagent.com", \
            f"Expected origin 'https://financial-level-ui.preview.emergentagent.com', got '{data['origin']}'"
